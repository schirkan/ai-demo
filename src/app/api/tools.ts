import { tool, experimental_generateImage, JSONValue } from 'ai';
...
export const generateImage = tool({
  ...
  execute: async ({ prompt, hdQuality, style, seed }) => {
    ...
    return { url: uploadResponse.url } // todo: save other output fields
  },
});